...
static char *g_TexturName[TEXTURE_MAX] = {
	"data/TEXTURE/resultBG000.jpg",
	"data/TEXTURE/result_logo000.png",
	"data/TEXTURE/number_480×96.png",
};
...
HRESULT InitResult(void)
{
	...
	// BGM再生
	PlaySound(SOUND_LABEL_BGM_result000);
...
void UpdateResult(void)
{
	...
	{// Enter押したら、ステージを切り替える
		PlaySound(SOUND_LABEL_SE_nextscene000);
...
void DrawResult(void)
{
	...
	// リザルトの背景を描画
	{
		...
		SetSpriteLeftTop(g_ertexBuffer, 0.0f, 0.0f, g_w, g_h, 0.0f, 0.0f, 1.0f, 1.0f);
	...
	// スコア表示
	{
		...
		for (int i = 0; i < SCORE_DIGIT; i++)
		{
			...
			// １枚のポリゴンの頂点とテクスチャ座標を設定
			SetSpriteColor(g_ertexBuffer, px, py, pw, ph, tx, ty, tw, th,
